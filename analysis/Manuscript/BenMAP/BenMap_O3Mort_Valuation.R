...
base_vsl = 9.33e6 #us vsl in 2020$ 
# from USEPA 2006 value in 2010 guidance 
Elasticity = 1
# turn 20-year cessation flag on (=1) or off (=0)
cessation_flag = 1
...
#Where a country does not have a VSL (e.g., where there was no public RFF GDP data), asign the regional VSL
